...
const ProductList = () => {
  ...
  // Helper to safely get array fields (handles both singular/plural names)
  const getArrayField = (product, field) => {
    const value = product[field] || product[field + 's']; // try plural if singular not found
            ...
            <div style={{ padding: "20px", overflowY: "auto" }}>
                    ...
                    {viewProduct.images.map((img, i) => (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.target.src =
                            "https://via.placeholder.com/140x100?text=Error";
                        }}
                      />
                    ))}
                  </div>
              ...
              >
                {[
                  ...
                  {
                    label: "Price",
                    value: viewProduct.price ? `₹${viewProduct.price}` : "—",
                  },
                  {
                    label: "Discount",
                    value:
                  ...
                  ...(viewProduct.updatedAt !== viewProduct.createdAt
                    ? [
                        {
                          label: "Last Updated",
                          value: formatDate(viewProduct.updatedAt),
                        },
                      ]
                    : []),
                ].map((item) => (
              ...
              {getArrayField(viewProduct, 'specification').length > 0 && (
                <div
                  style={{
                    background: "#f9fafb",
                    borderRadius: 10,
                ...
                >
                  ...
                  <ul style={{ margin: 0, paddingLeft: 18, color: "#374151", fontSize: 13 }}>
                    {getArrayField(viewProduct, 'specification').map((spec, i) => (
                      <li key={i} style={{ marginBottom: 4 }}>{spec}</li>
                    ))}
                  </ul>
                </div>
              )}
              ...
              {getArrayField(viewProduct, 'description').length > 0 && (
                <div
                  style={{
                    background: "#f9fafb",
                    borderRadius: 10,
                ...
                >
                  ...
                  <ul style={{ margin: 0, paddingLeft: 18, color: "#374151", fontSize: 13 }}>
                    {getArrayField(viewProduct, 'description').map((desc, i) => (
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      e.target.onerror = null;
                      e.target.src =
                        "https://via.placeholder.com/400x175?text=Not+Found";
                    }}
                  />
                  {product.images && product.images.length > 1 && (
                    <span
                    ...
                    item === "..." ? (
                      ...
                      <button
                        ...
                        style={{
                          ...
                          height: 34,
                          borderRadius: 8,
                          border: `1.5px solid ${currentPage === item ? "#1a1a1a" : "#e5e7eb"}`,
                          background: currentPage === item ? "#1a1a1a" : "#fff",
